/*2020 Day 4-a advent calendar ZTM puzzle solution by Felipe Moreno
...
dataList.forEach(element => {
    ...
    let numberOfFields = fieldsInString.length/2; 
    if (numberOfFields<7 || ( numberOfFields==7 && fieldsInString.includes("cid"))) {} else {counter++;}  // just count the right passports    
});
